    ...
    _call: function (params, callback) {
      ...
      $.getJSON(url, function (data) {
        if (data.stat === 'ok') {
          ...
          Galleria.raise(
            data.code.toString() + ' ' + data.stat + ': ' + data.message,
            true,
          )
        }
      })
