...
;(function (window, factory) {
  ...
  Galleria.addTheme({
    ...
    init: function (options) {
      Galleria.requires(
        1.6,
        'This version of Folio theme requires Galleria version 1.6 or later',
      )
      ...
      var self = this,
        ...
        adjustInfo = function (width) {
          self.$('info').css({
            left: self.finger
              ? 20
              : Math.max(20, $(window).width() / 2 - width / 2 + 10),
          })
        },
        mi = function (arr) {
      ...
      this.bind('fullscreen_exit', function (e) {
        if (this.getData().iframe) {
          $(this._controls.getActive().container)
            .find('iframe')
            .remove()
          ...
          masonry(thumbnails, {
            ...
            onbrick: function () {
              ...
              window.setTimeout(
                              ...
                              Galleria.utils.animate(
                                ...
                                },
                                {
                                  ...
                                  complete: function () {
                                    ...
                                    if (self.finger) {
                                      self.finger.setPosition(
                                        -index * self.finger.width,
                                      )
                                    }
                                    self.show(index)
                                  },
                ...
                options._animate ? image.parent().data('index') * 100 : 0,
              )
            },
            onheight: function () {
