...
;(function (window, factory) {
  ...
  Galleria.addTheme({
    ...
    init: function (options) {
      Galleria.requires(
        1.6,
        'This version of Twelve theme requires Galleria version 1.6 or later',
      )
      ...
      var gallery = this,
        ...
        scaleThumbs = function () {
          thumbs
            .height(gallery.getStageHeight())
            .width(gallery.getStageWidth())
            .css('top', OPEN ? 0 : gallery.getStageHeight() + 30)
        },
        toggleThumbs = function (e) {
          ...
          Galleria.utils.animate(
            ...
            { top: OPEN ? gallery.getStageHeight() + 30 : 0 },
            {
              ...
              duration: 400,
              complete: function () {
                gallery.defineTooltip(
                  'thumblink',
                  OPEN ? lang.show_thumbnails : lang.hide_thumbnails,
                )
